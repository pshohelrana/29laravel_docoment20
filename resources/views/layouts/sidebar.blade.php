<aside class="main-sidebar sidebar-info elevation-4"style="background: #ede7f6">
      <!-- Brand Logo -->
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <img src="{{asset('asset/dist/img/rana.jpg')}}" class="img-circle elevation-2" alt="User Image">
          </div>
          <div class="info">
